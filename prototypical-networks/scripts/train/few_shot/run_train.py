...
parser.add_argument('--model.stn_loss', type=str, default='identitydistance',
                    help='Get theta loss' )
...
parser.add_argument('--run_stn', type=bool, default=False, help='Whether to use the STN module')
parser.add_argument('--model.stn_model', type=str, default=default_stn_name, metavar='STNMODELNAME', help="stn model name (default: {:s})".format(default_stn_name))
parser.add_argument('--train.concat_stn', type=int, default=False, help='Do we concatenate the outputs of STN and original images?')

parser.add_argument('--train.stn_weight_decay', type=float, default=default_weight_decay, metavar='WD' )
parser.add_argument('--train.stn_learning_rate', type=float, default=0.001, metavar='LR',
...
parser.add_argument('--train.gamma', type=float, default=0.95, metavar='GAMMA',
...
parser.add_argument('--seed', type=int, default=1234, metavar='SEED',
                    help='Random seed for reproducbility')
# log args
